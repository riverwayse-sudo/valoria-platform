...
export { computeFingerprint, isLockActive, buildLockRecord } from './lockEngine.cjs';
import { isLockActive as _isLockActive, computeFingerprint as _computeFingerprint } from './lockEngine.cjs';
