...
} from "./scoringEngine.cjs";

// Holds the Supabase access token for the current session once the person
// signs up. Sent to /api/report and /api/send-email so those endpoints can
// verify a real logged-in user is calling them, instead of accepting any
// anonymous request.
...
function ResultsScreen({ name, role, results, onRetake, onSignupDone }) {
  ...
  async function handleSignup() {
    ...
    try {
      ...
      currentAuthToken = authData?.access_token || null;
