...
export default function Nav() {
  ...
  useEffect(() => {
    ...
    // `launched` here is live (see useLaunchStatus), so this re-runs and
    // correctly opens the nav the instant the gate lifts, even for a tab
    // that's been sitting open on the page since before launch.
    if (launched) {
      setGateCleared(true)
      return
    }
